 ...
 */
public class TagViewerIn extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tag_viewer_in);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TagViewerIn.this, TagViewerOut.class);
        ...
        if (mAdapter == null) {
            ...
            Toast.makeText(TagViewerIn.this, "ERROR! " + R.string.no_nfc, Toast.LENGTH_SHORT).show();
            finish();
            return;
        }
